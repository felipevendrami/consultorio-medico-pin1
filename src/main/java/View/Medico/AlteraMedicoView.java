 ...
 * @author lucas
 */
public class AlteraMedicoView extends javax.swing.JFrame implements MedicoObserver {
    ...
    public AlteraMedicoView(MedicoController medicoController, Long idMedico) {
        initComponents();
        this.medicoController = medicoController;
        this.medicoController.addViewObserver(this);
        try {
            this.medicoController.buscaMedico(idMedico);
        } catch (Exception e) {
    ...
    private void addAcoes() {
        btConfirmar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    validaCampos();
                    medicoController.modificaMedico(montaMedico());
                    setVisible(false);
                } catch (Exception ex) {
