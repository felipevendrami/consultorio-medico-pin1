 ...
 * @author felip
 */
public class AlteraPessoaView extends javax.swing.JFrame implements PessoaObserver {
    ...
    public AlteraPessoaView(PessoaController pessoaController, Long idUsuario) {
        initComponents();
        this.pessoaController = pessoaController;
        this.pessoaController.addViewObserver(this);
        try {
            this.pessoaController.buscaPessoa(idUsuario);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("> Alterar Pessoa");
