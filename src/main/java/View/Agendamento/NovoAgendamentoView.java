 ...
 * @author felip
 */
public class NovoAgendamentoView extends javax.swing.JFrame implements AgendamentoObserver{
    ...
    public NovoAgendamentoView(AgendamentoController agendamentoController) {
        initComponents();
